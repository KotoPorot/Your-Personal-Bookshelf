...
const BookModal = ({
	...
	const currentShelf = shelves.find(
		(s) => Number(s.id) === Number(book.shelfId),
	);
	...
	const handleDelete = () => {
		if (
			window.confirm(`Вы уверены, что хотите удалить книгу "${book.title}"?`)
		) {
						...
						<>
							...
							<div className="book-info-grid">
								...
								<div className="info-row">
									...
									<span className="info-value shelf-highlight">
										{shelfName}
									</span>
								</div>
								...
								<div className="info-row">
									...
									<span className="info-value">
										{loading
											? "..."
											: `${currentSection} из ${numberOfSections}`}
									</span>
								</div>
								...
								<div className="info-row">
									...
									<span className="info-value">
										{loading
											? "..."
											: `${currentChapterInSection} из ${numberOfChaptersInSection}`}
									</span>
								</div>
