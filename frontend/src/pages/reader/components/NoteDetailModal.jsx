    ...
    return (
        <div className="note-detail-drawer" onClick={(e) => e.stopPropagation()}>
            <div className="note-detail-header">
                ...
                <button className="notes-close-btn" onClick={actions.handleCloseDetailNote}>✕</button>
            </div>
            ...
            <div className="note-detail-body">
                ...
                <div className="note-detail-actions">
                    <button className="btn-navigate" onClick={() => actions.handleJumpToNote(activeDetailNote.cfi)}>
                        🚀 Перейти к заметке
                    </button>
                    <button className="btn-delete" onClick={() => actions.handleDeleteNote(activeDetailNote.noteId)}>
                        🗑 Удалить
                    </button>
                </div>
            </div>
